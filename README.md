...
- [ ] **資安管理**：正確使用 `GitHub Secrets` 存放 OpenCode Go API Key 與 Discord Webhook。

### Phase 2: 代理人大腦 (Rust & AI)

- [ ] **非同步請求**：使用 `tokio` + `reqwest` 呼叫 OpenCode Go API。
